function loadLevel1() {
    ...
    if (currentTarget === "LR 5") {
        ...
        m2 = `
            <a-text value="TURN LEFT AND GO STRAIGHT UNTIL JUNCTION 2" position="0 1.5 0" align="center" color="#000000" rotation="-90 0 0" scale ="1 1 1"></a-text>
        ...
        m3 = `
            <a-text value="TURN LEFT" position="0 1.5 0" align="center" color="#000000" rotation="-90 0 0" scale ="1 1 1"></a-text>
            <a-entity geometry="primitive: cone" material="color: lime" rotation="-90 90 0" position="0 0.2 0" scale="0.5 0.7 0.5"></a-entity>`;

        // --- MARKER 4: FINAL JUNCTION ---
        m4 = `
            <a-text value="ENTER THE HALLWAY BEHIND YOUR BACK AND LR 5 IS ON YOUR RIGHT" position="0 1.5 0" align="center" color="#000000" rotation="-90 0 0"scale ="1 1 1"></a-text>
        ...
        m5 = `
            <a-text value="DESTINATION REACHED" position="0 2.5 0" align="center" color="#00FF00" rotation="-90 0 0" scale ="1 1 1"></a-text>
            <a-text value="LR 5" position="0 1.8 0" align="center" color="white" rotation="-90 0 0""></a-text>
